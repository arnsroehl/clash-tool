...
function createInputFromRecommendation(params: {
  ...
  return {
    ...
    shinyOreCost: params.recommendation.nextLevelCosts.shinyOre,
    glowyOreCost: params.recommendation.nextLevelCosts.glowyOre,
    starryOreCost: params.recommendation.nextLevelCosts.starryOre,
