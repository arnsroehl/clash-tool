      ...
      <summary className="cursor-pointer list-none p-5">
        ...
        <p className="mt-1 text-sm text-slate-400">
          ...
          {building.countAfterMerges && building.countAfterMerges > 1
            ? ` · ${building.countAfterMerges}× ${en ? "available" : "vorhanden"}`
            : ""}
          {building.buildingCount !== building.countAfterMerges
            ? ` · ${en ? "before merge" : "vor Merge"} ${building.buildingCount}×`
            : ""}
        </p>
      </summary>
          ...
          return (
            ...
            >
              <span className="font-medium">
                {building.name} {instanceIndex}
              </span>
              <div className="flex items-center gap-3">
                <button
                  onClick={() =>
                    onUpdateLevel(building, instanceIndex, currentLevel - 1)
                  }
